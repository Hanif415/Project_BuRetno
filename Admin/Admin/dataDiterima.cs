...
namespace Admin
{
    public partial class dataDiterima : Form
    {
        public dataDiterima()
        {
            InitializeComponent();
        ...
        private void display_data()
        {
            ...
            command.CommandText = "SELECT * FROM data_pendaftaran WHERE usia > " + 6;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection conn = Koneksi.getKoneksi();
            MySqlCommand command = conn.CreateCommand();
            command.CommandText = "SELECT * FROM data_pendaftaran WHERE nama_lengkap LIKE '%" + namaLengkap + "%' AND usia >= " + 6;
